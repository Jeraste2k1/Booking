...
// $data=$db->query("SELECT * chambre");

$data=$db->prepare("SELECT *  from chambre");
$data->execute();
    ...
    <div class="container-xxl bg-white p-0">
        ...
        <div class="container-xxl py-5">
            ...
            <div class="container">
                ...
                <div class="row g-4">
                <?php while($row= $data->fetch(PDO::FETCH_ASSOC)){?> <!--dublication de modèle-->
                    <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                        ...
                        <div class="room-item shadow rounded overflow-hidden">
                            ...
                            <div class="position-relative">
                                ...
                                <small class="position-absolute start-0 top-100 translate-middle-y bg-primary text-white rounded py-1 px-3 ms-4"><?= $row["prixbynight"] ?>F/Night</small>
                            ...
                            <div class="p-4 mt-2">
                                ...
                                <div class="d-flex justify-content-between mb-3">
                                    ...
                                    <h5 class="mb-0"><?= $row["typechambre"] ?></h5>
                                ...
                                <div class="d-flex mb-3">
                                    ...
                                    <small><i class="fa fa-wifi text-primary me-2"></i>Numéro de chambre : <?= $row["numchambre"] ?></small>
